...
uint8_t ACI_GAP_SET_NON_DISCOVERABLE[] = {0x01, 0x81, 0xFC}; // TODO - fill this in
//uint8_t ACI_GAP_SET_NON_DISCOVERABLE_COMPLETE[] = {}; // TODO - fill this in
uint8_t ACI_GAP_SET_NON_DISCOVERABLE_COMPLETE[] = {0x04, 0x0E, 0x04, 0x01, 0x81, 0xFC, 0x00};  // Success (0x00)
